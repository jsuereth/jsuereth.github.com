...
---
Well, we're off to a rocky start.  First off, the Ubuntu server kernel expects a particular processor extension that does not exist in the virtualbox emulation:  <a href="https://bugs.launchpad.net/ubuntu/+source/linux/+bug/216784">see here for a fix</a>
...
h4. Creating a directory for the project
Run the following:
